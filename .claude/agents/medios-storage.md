...
- Assets versionados: `public/brand/`, `public/images/products/<slug>/` (`<slug>-caja.webp`, `<slug>-aplicacion-NN.webp`, `ficha-tecnica-<slug>.pdf`), `public/images/photos/` (fotos editoriales por ruta en JSX, **sin** `media_assets`) y `public/images/blog/` (derivados de las portadas de artículos, **temporal**: desde el 2026-08-21 las portadas se suben desde el panel y quedan como medios R2, así que esta carpeta y el script de respaldo `2026-08-20-covers-blog.sql` se borran cuando estén cargadas)
