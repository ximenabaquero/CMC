  ...
  return (
    <>
      ...
      {/* El momento de mayor credibilidad es el final del artículo: ahí va
          el camino a WhatsApp, como en el resto del sitio. La banda se
          extrajo a `BlogCta` el 2026-09-03 para que el índice de /blog cierre
          igual y el mensaje viva en un solo sitio. */}
      <BlogCta id="cta-articulo" settings={settings} />
    </>
  );
}
