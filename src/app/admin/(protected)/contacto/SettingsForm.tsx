    ...
    <form action={formAction} className="space-y-6">
      <fieldset className="space-y-4 rounded-lg border border-border bg-surface p-5">
        ...
        <TextField
          ...
          maxLength={150}
        />
        <TextField label="Eslogan" name="slogan" defaultValue={settings.slogan} maxLength={200} />
      </fieldset>

      <fieldset className="space-y-4 rounded-lg border border-border bg-surface p-5">
        <legend className="px-1 text-sm font-semibold">Canales de contacto</legend>
        <div className="grid gap-4 sm:grid-cols-2">
          <TextField label="Teléfono" name="phone" defaultValue={settings.phone} maxLength={50} />
          <TextField
            label="WhatsApp"
            name="whatsapp"
          ...
          <TextField
            ...
            maxLength={150}
          />
          <TextField label="Ciudad" name="city" defaultValue={settings.city} maxLength={100} />
        </div>
        <TextField label="Dirección" name="address" defaultValue={settings.address} maxLength={300} />
        <TextField
      ...
      <fieldset className="space-y-4 rounded-lg border border-border bg-surface p-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <TextField label="TikTok (URL)" name="tiktok_url" defaultValue={settings.tiktok_url} />
        </div>
      </fieldset>
